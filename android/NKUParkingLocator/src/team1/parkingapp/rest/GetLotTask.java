...
public class GetLotTask extends AsyncTask<String, String, String> {
	...
	private static Vector<ParkingLot> parkingLots;
	...
	protected String doInBackground(String... params)
	{
		    ...
		    HttpGet httpget = new HttpGet(RestContract.LOTS_API);
		    ...
		    try {
		        ...
		        if(status.getStatusCode() == HttpStatus.SC_OK)
		        {
	                ...
	                GetLotTask.parkingLots = parseResults(out.toString());
		        	out.close();
		        }
